...
tags:
    - post format
image:
   thumb: "examples/gallery-example-1-thumb.jpg"
gallery:
    - image_url: examples/gallery-example-1.jpg
      caption: Great images by Unsplash.com
    - image_url: examples/gallery-example-2.jpg
      caption: Great images by Unsplash.com
    - image_url: examples/gallery-example-3.jpg
      caption: Great images by Unsplash.com
    - image_url: examples/gallery-example-4.jpg
      caption: Great images by Unsplash.com
    - image_url: examples/gallery-example-5.jpg
      caption: Great images by Unsplash.com
    - image_url: examples/gallery-example-6.jpg
      caption: Great images by Unsplash.com
    - image_url: examples/gallery-example-7.jpg
      caption: Great images by Unsplash.com
    - image_url: examples/gallery-example-8.jpg
      caption: Great images by Unsplash.com
---
...
~~~
gallery:
    - image_url: examples/gallery-image.jpg
~~~
