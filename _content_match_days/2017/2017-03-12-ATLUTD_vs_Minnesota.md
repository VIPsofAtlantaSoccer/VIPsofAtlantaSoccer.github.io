...
# Article metadata
# ---------------------------------------------------------------------------
title: "Atlanta United Rolls Through the Snow for First MLS Victory"
subheadline: "Josef Martínez scores a hat trick and Miguel Almirón adds two goals as Atlanta defeats Minnesota United 6-1 in a snow-covered Minneapolis"
teaser: "Winter conditions failed to slow Atlanta United's attack. Behind a Josef Martínez hat trick and two goals from Miguel Almirón, the expansion side earned the first league win in club history with a commanding 6-1 victory over Minnesota United."
...
# Asset Directory
# ---------------------------------------------------------------------------
content_assets: /content_assets/2017/2017-03-12-ATLUTD_vs_Minnesota

# ---------------------------------------------------------------------------
# Hero Image
# ---------------------------------------------------------------------------
hero:
    file: /content_assets/2017/2017-03-12-ATLUTD_vs_Minnesota/2017-03-12 - C6vtxXwU0AAiymU.webp
...
Atlanta United's first MLS road victory arrived in conditions that looked more suited to winter than the opening weeks of a soccer season. Snow covered the field at TCF Bank Stadium and continued to fall throughout the afternoon, forcing the use of an orange match ball for visibility. The weather became the visual identity of the match, but it did little to slow Atlanta's attack.
...
{% include centered_image.html
   file="2017-03-12 - tzw0qpjvszxgf1vpvlob.webp"
   caption="( Photo by ATLUTD )"
%}
...
{% include centered_image.html
   file="2017-03-12 - C6wVCDnV4AAi29H.webp"
   caption="( Photo by ATLUTD )"
%}

Atlanta resumed control soon after the restart. Héctor Villalba received a yellow card at 47', but the visitors quickly restored their three-goal cushion when Almirón scored his second goal of the match at 51'.
