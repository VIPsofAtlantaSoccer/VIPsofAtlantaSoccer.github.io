...
opponent_id: "MLS_NextPro_Carolina"     # Must match ID in site.data.Opponents
...
syndication:
    ...
    original_url: "https://www.patreon.com/posts/atlanta-united-2-157271224"   # overrides affiliations link
...
{% include centered_image.html
   file="Ransom 1.webp"
   caption="Jonathan Ransom ( Photo by ATLUTD2 )"
%}
...
{% include centered_image.html
   file="Chong Qui 1.webp"
   caption="Dominik Chong-Qui ( Photo by ATLUTD2 )"
%}
