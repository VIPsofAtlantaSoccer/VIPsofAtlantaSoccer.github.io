...
# Article metadata
# ---------------------------------------------------------------------------
title: "Resilience in Orlando: Fortune’s Late Strike Secures 1-1 Draw"
subheadline: "Atlanta builds pressure through cleaner sequences but leaves the back door open to the counter."
teaser: "Despite controlling territory and racking up 22 shots, Atlanta United had to rely on late-match resilience and an 86th-minute equalizer to rescue a point against a direct Orlando counter-attack."
...
hero:
    file: /content_assets/2026/2026-05-15-ATLUTD_vs_Orlando/2026-05-17 - HIe5VLwXsAAYaZn.webp
    caption: "( Photo by Orlando City )"
...
# Optional
# ---------------------------------------------------------------------------
opponent_id: "MLS_Orlando"   # Must match ID in site.data.Opponents
location:    "Away"      # "Home" | "Away" | "Neutral"

competition: "Regular Season"   # ex: "Regular Season"
match_date:  2026-05-16      # YYYY-MM-DD
...
syndication:
    ...
    original_url: "https://www.patreon.com/posts/resilience-in-1-158584642"   # overrides affiliations link
...
{% include quote.html
   mode=""
   quote="The fact that we came back from a 1-0 result, to keep searching for the game after going level, we had the last play to win the game.  I think that even if a draw isn’t so bad because they had 20 very good minutes in the first half, I think we could have won."
...
{% include centered_image.html
   file="2026-05-16 - Jacob.webp"
   caption="Atlanta United defender Tomás Jacob #55 passes the ball during the first half of the match against Orlando City at Inter&Co Stadium in Orlando, FL on Saturday May 16, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-05-16 - Saba.webp"
   caption="Atlanta United defender Saba Lobjanidze #11 dribbles during the first half of the match against Orlando City at Inter&Co Stadium in Orlando, FL on Saturday May 16, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-05-16 - Galarza.webp"
   caption="Atlanta United midfielder Matías Galarza #88 dribbles during the second half of the match against Orlando City at Inter&Co Stadium in Orlando, FL on Saturday May 16, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-05-16 - Fortune_celebration_2.webp"
   caption="Atlanta United midfielder Ajani Fortune #35 celebrates after a goal during the second half of the match against Orlando City at Inter&Co Stadium in Orlando, FL on Saturday May 16, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include quote.html
   mode=""
   quote="I saw throughout the game, the top of the box was free a little bit, and I was just waiting for the opportunity. I was telling myself I can get one in this game. Matt Edwards on the right, and, luckily, we've had a connection for quite a few years, so he always knows to look for the cutback, and from there, it's on me to hit the target, and gladly went in."
   speaker="Jay Fortune, ATLUTD Midfielder"
   source="Apple TV Interview"
...
{% include quote.html
   mode=""
   quote="it’s up to me to take advantage of a group of players from the Academy that have excellent qualities. I’ll repeat: Jayden, Matt, Jay, Cooper, Will, Luke. There aren’t many teams who can produce players from the Academy who provide so much trust when you’re calling on them and I’m willing to take advantage of the situation."
   speaker="Tata Martino, ATLUTD Head Coach"
   source="Post Game Press Conference"
   image="/images/quotes/Tata Martino.jpg"
%}
...
{% include quote.html
   mode=""
   quote="I think they have an accumulation of matches that makes the fatigue start to set it. I think, undoubtedly, in neither of the games, this one or the next, were we going to play with a lower rhythm of play."
   speaker="Tata Martino, ATLUTD Head Coach"
   source="Post Game Press Conference"
   image="/images/quotes/Tata Martino.jpg"
%}
