...
# Article metadata
# ---------------------------------------------------------------------------
title: "Atlanta United Falls Flat 2-0 vs Columbus Before the Break"
subheadline: "A night that carried evaluation stakes before the transfer window instead reinforced the questions Atlanta carried into Columbus."
teaser: "Atlanta United entered Columbus needing clarity before the break. Instead, a passive first half and a limited second-half response left the same questions hanging over the team."
...
match_date:  2026-05-24      # YYYY-MM-DD
...
{% include quote.html
   mode=""
   quote="We were very passive and we were lacking more intensity to cause friction, anticipate so that they couldn’t play with comfort."
...
{% include centered_image.html
   file="2026-05-24 - Brennan.webp"
   caption="Atlanta United forward Luke Brennan #20 dribbles during the match against Columbus Crew at ScottsMiracle-Gro Field in Columbus, OH on Sunday May 24, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-05-24 - Mihaj.webp"
   caption="Atlanta United defender Enea Mihaj #4 dribbles during the match against Columbus Crew at ScottsMiracle-Gro Field in Columbus, OH on Sunday May 24, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-05-24 - Sanchez.webp"
   caption="Atlanta United midfielder Cooper Sanchez #48 dribbles during the match against Columbus Crew at ScottsMiracle-Gro Field in Columbus, OH on Sunday May 24, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-05-24 - Santos.webp"
   caption="Atlanta United forward Sergio Santos #19 strikes the ball during the match against Columbus Crew at ScottsMiracle-Gro Field in Columbus, OH on Sunday May 24, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
Several players entered the night needing to strengthen their case before the transfer window and the next evaluation phase of the season.  Brennan pressed well in moments, Fortune recovered well in midfield, and Jacob stepped forward into a few useful attacks.  None of it was enough.  Too many other performances blended into the background.  For a player-by-player look at those performances, read [Player Impressions: ATLUTD 0-2 Columbus Crew](/2026/05/24/atlutd-vs-columbus-player-impressions/).
...
{% include quote.html
  mode="important"
  quote="I’m more upset about the first goal we conceded because we had an opportunity to hurt them on a set piece and we finished the play conceding a goal. I’m more upset about this one. The second goal also put us in a difficult situation but we just have to be better and smarter and it’s kind of childish how we concede goals."
  speaker="Tristan Muyumba, ATLUTD Midfielder"
  source="Post-Match Press Conference"
  image="/images/quotes/Tristan Muyumba.jpg"
%}
