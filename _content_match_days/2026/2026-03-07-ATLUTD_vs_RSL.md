...
opponent_id: "MLS_RSL"     # Must match ID in site.data.Opponents
...
key_events:
   for:
      ...
      - type: Goal
        ...
        minute: 74
      - type: Sub
        player: "Edwards on/Jacobs off"
        minute: 79
      - type: Sub
        player: "Lobjanidze on/Alzate off"
        minute: 79
      - type: Sub
        player: "Santos on/Mihaj off"
        minute: 86
   ...
   against:
      ...
      - type: Yellow Card
        ...
        minute: 44
      - type: Sub
        player: "Dillon on/Moisa off"
        minute: 45
      - type: Sub
        player: "Marczuk on/Hezarkhani off"
        minute: 62
      - type: Sub
        player: "Barea on/Solans off"
        minute: 81
      - type: Sub
        player: "Booth on/Guilavogui off"
        minute: 85
      - type: Sub
        player: "Janqua on/Quinton off"
        minute: 85
      - type: Yellow Card
        player: "Gozo"
        minute: 90+1
