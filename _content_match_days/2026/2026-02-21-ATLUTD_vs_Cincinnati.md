...
opponent_id: "MLS_Cincinnati"     # Must match ID in site.data.Opponents
...
key_events:
   for:
      ...
      - type: Sub
        ...
        minute: 73
      - type: Sub
        player: "Muyumba on for Sanchez"
        minute: 73
      - type: Sub
        player: "Brennan on for Alzate"
        minute: 84

   against:
      - type: Sub
        player: "Valenzuela on for Evander"
        minute: 13
      - type: Yellow Card
        player: "Bryan Ramírez"
        minute: 26
      - type: Sub
        player: "Barlow on for Jabbari"
        minute: 71
      - type: Sub
        player: "Flores on for Hadebe"
        minute: 71
      - type: Goal
        player: "Kévin Denkey"
        minute: 80
      - type: Sub
        player: "Powell on for Echenique"
        minute: 89
      - type: Sub
        player: "Nwobodo on for Valenzuela"
        minute: 89
      - type: Goal
        player: "Nick Hagglund"
        minute: 90
