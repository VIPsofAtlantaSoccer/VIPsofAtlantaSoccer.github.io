...
# Article metadata
# ---------------------------------------------------------------------------
title: "ATLUTD shell-shocked from a 4-1 pummeling by Orlando"
subheadline: "Martino’s rotated lineup collapsed under Orlando’s early pressure"
teaser: "Atlanta United spent the opening half chasing runners, clearing emergencies, and conceding goals as Orlando City ripped apart a rotated defensive setup before halftime."
...
competition: "US Open Cup"   # ex: "Regular Season"
match_date:  2026-05-19      # YYYY-MM-DD
...
Orlando punished the miss two minutes later.  Iván Angulo ran onto a through ball behind Atlanta’s line, drove into the box, and squared the ball across goal for Dorsey to finish.  The goal was not just another defensive lapse.  It was the same problem repeated with more damage: Atlanta’s midfield pressure never slowed the first pass, the back line dropped in recovery, and Orlando’s runner arrived with the play already moving toward goal.

{% include quote.html
   mode=""
   quote="[I thought] the team was up to an evolution in its play, and the idea was to match up with the five forwards that [Orlando] use and we weren’t prepared for that and it’s absolutely my responsibility."
...
{% include quote.html
   mode=""
   quote="I understood that the team was up to an evolution in its play and the idea was to match up with the five forwards that they use and we weren’t prepared for that and it’s absolutely my responsibility."
   speaker="Tata Martino, ATLUTD Head Coach"
   source="Post-Match Press Conference"
   image="/images/quotes/Tata Martino.jpg"
%}
