...
opponent_id: "MLS_Philadelphia_Union"     # Must match ID in site.data.Opponents
...
key_events:
  for:
    - type: Goal
      player: "Latte Lath (Almirón, Báez)"
      minute: 28
    - type: Yellow Card
      player: "Báez"
      minute: 40
    - type: Yellow Card
      player: "Tata Martino (Head Coach)"
      minute: 41
    - type: Yellow Card
      player: "Jorge Theiler ( Assistant Coach )"
      minute: 43
    - type: Yellow Card
      player: "Gregersen"
      minute: 46
    - type: Goal
      player: "Jacob (Almirón, Galarza)"
      minute: 47
    - type: Yellow Card
      player: "Galarza"
      minute: 49
    - type: Goal
      player: "Miranchuk (Almirón, Latte Lath)"
      minute: 68
    - type: Sub
      player: "Picault (on)/Latte Lath (off)"
      minute: 69
    - type: Sub
      player: "Alzate (on)/Galarza (off)"
      minute: 69
    - type: Sub
      player: "Lobjanidze (on)/Miranchuk (off)"
      minute: 78
    - type: Yellow Card
      player: "Jacob"
      minute: 85
    - type: Sub
      player: "Edwards (on)/Sanchez (off)"
      minute: 87
    - type: Sub
      player: "Amador (on)/Almirón (off)"
      minute: 88

  against:
    - type: Sub
      player: "Alladoh (on)/Korzeniowski (off)"
      minute: 57
    - type: Sub
      player: "Anello (on)/Vassilev (off)"
      minute: 57
    - type: Sub
      player: "Bedoya (on)/Iloski (off)"
      minute: 57
    - type: Sub
      player: "Sery Larsen (on)/Ndinga (off)"
      minute: 77
    - type: Sub
      player: "Bueno (on)/Jean Jacques (off)"
      minute: 81
    - type: Goal
      player: "Anello (Westfield, Bedoya)"
      minute: 87
...
Martino pointed to that sequence afterward as an example of how the three DPs worked together.

{% include quote.html
    mode=""
    quote="On the third goal, you saw the reverse of what you usually see, with Alexey usually playing the pass in the box to Miguel, but today it was reversed. All three played a very good match and played very well."
    speaker="Tata Martino"
    source="Post-game Press Conference"
    image="/images/quotes/Tata Martino.jpg"
%}
...
The right side of the field played an important role in that shift. Jacob and Sanchez were active early, and Almirón repeatedly found space moving through that channel. As the match opened up, Atlanta began finding more consistent combinations through midfield, particularly between Almirón and Galarza.

{% include quote.html
  mode=""
  quote="It was not an easy game, kind of a dog fight if you want to call it that. Philly is always like that, very physical so happy to get the job done today."
  speaker="Cooper Sanchez"
    source="Post-game Press Conference"
...
For the first time this season, the pieces looked like they were beginning to fit together.
