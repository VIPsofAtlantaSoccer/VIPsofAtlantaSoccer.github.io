...
opponent_id: "MLS_San_Jose"     # Must match ID in site.data.Opponents
...
key_events:
   for:
      ...
      - type: Yellow Card
        ...
        minute: 52
      - type: Sub
        player: "Muyumba on for Hernández"
        minute: 60
      - type: Sub
        player: "Miranchuk on for Lobjanidze"
        minute: 60
      - type: Sub
        player: "Amador on for Sanchez"
        minute: 70
      - type: Own Goal
        player: "Tomás Jacob"
        minute: 79
   ...
   against:
      - type: Goal
        ...
        minute: 24
      - type: Sub
        player: "Werner on for Judd"
        minute: 61
      - type: Sub
        player: "Skahan on for Ricketts"
        minute: 77
      - type: Sub
        player: "Gonzalez on for Leroux"
        minute: 77
      - type: Sub
        player: "Fernandez on for Bouda"
        minute: 90
      - type: Sub
        player: "Marie on for Tsakiris"
        minute: 90
      - type: Yellow Card
        player: "Jones"
        minute: 90
...
syndication:
  ...
  original_url: "https://www.patreon.com/posts/atlanta-united-2-151960085"   # overrides affiliations link
...
{% include quote.html
  mode=""
  quote="It concerns me the lack of decisiveness the team had to start the game and to play the first half."
...
{% include quote.html
  mode=""
  quote="If you start like that in MLS, teams are going to punish you. We have many things to work on but I would say that mostly it’s the mental, attitude side."
  speaker="Juan Berrocal, ATLUTD Left Back"
  source="Post-Match"
  image="/images/quotes/Juan Berrocal.jpg"
%}
...
{% include quote.html
  mode=""
  quote="Clearly Alexey is a key player for us. Unfortunately, he suffered an injury at an inappropriate time... we hope... he can provide what he’s usually able to provide to the team."
  speaker="Tata Martino, ATLUTD Head Coach"
  source="Post-Match"
  image="/images/quotes/Tata Martino.jpg"
%}
...
{% include quote.html
  mode=""
  quote="We need to change the mindset. We need to have a winning mindset because that in life is a big factor. You have to think like a winner and that’s what is going to help you have success."
  speaker="Juan Berrocal, ATLUTD Left Back"
  source="Post-Match"
  image="/images/quotes/Juan Berrocal.jpg"
%}
