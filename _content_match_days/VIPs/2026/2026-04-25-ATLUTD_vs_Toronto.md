...
opponent_id: "MLS_Toronto"     # Must match ID in site.data.Opponents
...
{% include centered_image.html
   file="2026-04-25 - Togashi.webp"
   caption="Atlanta United forward Cayman Togashi #30 dribbles during the first half of the match against Toronto FC at BMO Field in Toronto, Canada on Saturday April 25, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-04-25 - Brennan.webp"
   caption="Atlanta United forward Luke Brennan #20 dribbles during the first half of the match against Toronto FC at BMO Field in Toronto, Canada on Saturday April 25, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
Atlanta created one more sequence before the break. Miranchuk found Fortune, who worked the ball into the corner and delivered a cross after a partial clearance. The final moments remained unsettled, with another offside call and a foul in a 50–50 challenge ending the half.

{% include quote.html
  mode=""
  quote="The first half I really liked. We couldn’t convert but we managed much of the game and suffered little. We controlled the game well. In the second half we were more concrete in front of goal but except for an important stretch after the 2-1 we had lost the control of the game."
...
{% include centered_image.html
   file="2026-04-25 - Celebration.webp"
   caption="Atlanta United midfielder Alexey Miranchuk #59 celebrates with teammates after a goal during the second half of the match against Toronto FC at BMO Field in Toronto, Canada on Saturday April 25, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
{% include centered_image.html
   file="2026-04-25 - Muyumba.webp"
   caption="Atlanta United midfielder Tristan Muyumba #8 dribbles during the first half of the match against Toronto FC at BMO Field in Toronto, Canada on Saturday April 25, 2026. (Photo by Mitch Martin/Atlanta United)"
%}
...
The last delivery came from a corner with Toronto’s keeper again forward. The ball carried across the box and over everyone.  The final whistle blue with Atlanta holding on to an invaluable 2–1 road win.
...
{% include Player_Impression.html
  ...
  text="Handled what came at him and distributed well into midfield. Collected crosses cleanly during pressure. Not tested beyond that. Reach still limits him."
%}

{% include Player_Impression.html
  name="Matt Edwards"
  image="/images/Player_Impressions/Matt Edwards.jpg"
  text="Got forward consistently and delivered from the right. Created early entries into the box. A few poor passes and nervy defensive moments."
%}

{% include Player_Impression.html
  name="Stian Gregersen"
  image="/images/Player_Impressions/Stian Gregersen.jpg"
  text="Reactive throughout. Won headers but did not control the line. Played off what was in front of him rather than anticipating it."
%}

{% include Player_Impression.html
  name="Juan Berrocal"
  image="/images/Player_Impressions/Juan Berrocal.jpg"
  text="Read the game well and stepped in to break up plays. Immediate reaction on the backpass save. Strongest presence in the back line."
%}

{% include Player_Impression.html
  name="Tristan Muyumba"
  image="/images/Player_Impressions/Tristan Muyumba.jpg"
  text="Covered ground and connected play through midfield. Took control of key sequences and finished the goal. Best performance of the season"
%}

{% include Player_Impression.html
  name="Luke Brennan"
  image="/images/Player_Impressions/Luke Brennan.jpg"
  text="Worked defensively and tracked back well. Had chances to influence the match but did not take them."
%}

{% include Player_Impression.html
  name="Jay Fortune"
  image="/images/Player_Impressions/Jay Fortune.jpg"
  text="Clean in tight spaces and linked play effectively. Combined well on the right. Continues to show quality."
%}

{% include Player_Impression.html
  name="Cooper Sanchez"
  image="/images/Player_Impressions/Cooper Sanchez.jpg"
  text="Involved early but faded. Heavy touches and the turnover leading to a free kick stood out. Looks to have leveled off."
%}

{% include Player_Impression.html
  name="Alexey Miranchuk"
  image="/images/Player_Impressions/Alexey Miranchuk.jpg"
  text="Connected play and stayed involved across phases. Delivered the free kick goal. Showed intent but did not control the match."
  quote="If I see my defenders doing his job really well and fighting for every ball, it gives me energy that I want to help him and help the team."
...
{% include Player_Impression.html
  ...
  text="Active off the ball and stretched the line. Took his chance on the disallowed goal. Injury cut short a promising start."
%}

{% include Player_Impression.html
  name="Emmanuel Latte Lath"
  image="/images/Player_Impressions/Emmanuel Latte Lath.jpg"
  text="Did not establish presence after coming on. Movement and pressure dropped from the position."
%}
...
Atlanta created enough through wide entries and central connections to score twice. They did not sustain those sequences, and the match shifted into defending crosses, second balls, and set pieces.

{% include quote.html
  mode="important"
  quote="I don’t want to put this in a way that from this we are going to win every game from now on, no. We want to play every game by game. It gives us big confidence inside of the group. Winning away games against a great team gives you a lot of courage and positive thoughts. Hopefully it will continue."
  speaker="Alexey Miranchuk, Atlanta United Midfielder"
  source="Post-game Press Conference"
