...
{% include centered_image.html
   ...
   caption="February 11, 2017 - Chattanooga FC at Atlanta United ( Photo by Atlanta United )"
%}
...
Carleton made his official MLS debut later that spring, entering against the Houston Dynamo on May 20, 2017, still only 16.
    ...
    {% include player_block.html
      ...
      caption="2018 ( Photo by Atlanta United )"
    ...
    {% include player_block.html
      ...
      caption="March 17th, 2018 - Vancouver W'caps at Atlanta United ( Photo by Atlanta United )"
      league="MLS"
...
Following his years in Atlanta, Carleton’s career went on to highlight the full spectrum of professional soccer in North America.
    ...
    {% include player_block.html
      ...
      caption="( Photo by San Diego Loyal )"
      league="USL Championship"
    ...
    {% include player_block.html
      ...
      caption="January 25th, 2022 ( Photo by Georgia Storm )"
      league="NPSL"
...
**Costa Rica**
- Appearances: 1 - Public match-by-match data for Liga de Ascenso is incomplete, and no verified match sheet has been found publicly to confirm the exact date or details of that appearance.
...
While it didn’t work out, it remains one of the most unique chapters in his career; relatively few American players spend time in Central American leagues.
    ...
    {% include player_block.html
      ...
      caption="2022 – ( Photo by San Diego Loyal )"
      league="USL Championship"
...
Andrew Carleton played in 11 games for ATLUTD, assisting 1.
