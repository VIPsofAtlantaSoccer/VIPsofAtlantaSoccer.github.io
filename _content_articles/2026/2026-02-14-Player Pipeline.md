...
# Content
#
subheadline: "Evaluation | Roster Management | 2026 Season"      # Subheadline = label:  what / where / when
title: "2026 Player Pipeline"               # 
teaser: "Potential has an expiration date. Atlanta United must decide who to trust and who to trade while their market value is at its peak."      # Teaser = pitch: why should I care
categories:
  - ATLUTD
tags:
author: VIPs
...
dates:
  - label: "Started"
    date: "2026-02-04"
  - label: "Submitted to Scarves & Spikes"
    date: "2026-02-08"

syndication:
  affiliation_id: "scarves" # Reference to ID in affiliations.yml
  original_url: "https://scarvesandspikes.com/2026/02/10/atlanta-uniteds-2026-player-pipeline-sideline-soapbox/"   # overrides affiliations link
