---
layout: page
title: "Should Miranchuk keep the armband?"
subheadline: "Atlanta’s recent matches show a shift toward structured, repeatable attacking sequences built around Miranchuk."
teaser: "The numbers point to more consistent attacks. The change isn’t in possession or volume. It’s in how attacks develop, where they end, and who decides the next action."
categories:
  - ATLUTD
tags:
...
# ---------------------------------------------------------------------------
syndication:
    affiliation_id: "scarves" # Reference to ID in affiliations.yml
    original_url: "https://scarvesandspikes.com/2026/05/09/sideline-soapbox-should-miranchuk-keep-the-armband/"   # overrides affiliations link
...
The sample is still small, but it spans three distinct phases, with Atlanta playing matches built around Miguel Almirón, matches where both were available, and matches where Alexey Miranchuk has been the primary central reference point. The question is not simply whether Miranchuk is performing well, but whether those shifts in structure point to a team that now depends on his decisions to control matches.

---

## What changed in Atlanta’s attacking structure?

Atlanta’s control of the match against CF Montréal began with where the ball consistently settled.  It settled centrally at the feet of Alexey Miranchuk.  Atlanta held 64.62% possession, which forced Montréal into extended defensive phases.  Those phases repeatedly opened the central lane between midfield and back line.
...
That control carries into how attacks reach their final action.  When sequences build through a consistent central reference point, the shot at the end of the move comes from more predictable positions rather than from forced situations.  The phases below show how those final actions differ across matches with Almirón, matches where both were available, and matches where Miranchuk has been the primary reference point.
...
|------|------|------|-------------|------|---------------|
| Almirón-dominant | 3/21 → 4/11 | DC, CLB, CHI | 0.059, 0.244, 0.080 | **0.128** | Highly inconsistent - swings between forced shots and good chances |
| Transition | 4/18 → 4/22 | NSH, NE | 0.064, 0.117 | **0.091** | Drops and remains unstable |
| Miranchuk-dominant | 4/25 → 5/2 | TOR, MTL | 0.082, 0.124 | **0.103** | Narrower range - more consistent shot selection |
...
|------|--------------|------|---------------|
| Almirón-dominant | 65.82, 55.45, 53.97 | **58.4%** | High but not decisive |
...
<!--
### Shot Location (Inside Box Rate)
-->

| Phase | Inside Box Shot Rate | Avg | What it shows |
|------|--------------------|------|---------------|
| Almirón-dominant | 0.556, 0.625, 0.550 | **0.577** | Decent but not improving |
...
Shot accuracy has not improved over this stretch.  Atlanta’s shots on target rate remains flat or slightly lower in recent matches.  Shots are not being struck more cleanly, and attempts are not hitting the target more often.

The difference appears earlier in the sequence.  More attacks now reach the box before the shot, and fewer possessions end in forced or low-value attempts.  The locations of those shots have changed even if the finishing has not.  That shift has made the team’s attacking output more consistent without relying on better shooting.
...
When he dropped into the half-space, the double pivot played forward instead of circulating across the back line.  The ball moved through him and into the next line before Montréal could shift its shape.  

When he stayed higher, Atlanta advanced through the wings before returning centrally.  As the ball moved wide, Montréal’s midfield stepped toward the ball.  The return pass into Miranchuk opened the lane into the final third.  
...
{% include quote.html
  mode=""
  quote="Tata said from the beginning, before we came here, how much talent Alexey has and I think the team is finding him in positions that he can score and make that difference. Six goals, but also quality passes, aggressive passes that allow us to attack and hurt the opposition."
  speaker="Rodrigo Ríos, Atlanta United Assistant Coach"
  source="April 28th, 2026 Post-game Press Conference"
...
{% include quote.html
  mode=""
  quote="He’s a great guy off the pitch and I’m so happy he is here with us. On the pitch, clearly you can see he is quality; he knows my game, I know his game so we are trying to use each other."
  speaker="Saba Lobjanidze, Atlanta United Winger"
  source="May 2nd, 2026 Post-game Press Conference"
  image="/images/quotes/Saba Lobjanidze.jpg"
%}
...
<!--
### Chance per Opportunities
-->

| Phase | Chance Rate | Avg | What it shows |
|------|-------------|------|---------------|
| Almirón-dominant | 1.0, 0.75, 1.0 | **0.917** | Erratic, with small-sample swings |
...
|------|-------------|------|---------------|
| Almirón-dominant | -0.528, -0.954, -1.602 | **-1.028** | Consistent underperformance |
...
---
## Does his presence improve teammates’ decisions?
...
Possessions end in organized areas of the field.  Turnovers occur with Atlanta’s shape already set, allowing the team to step forward and recover the ball instead of retreating into emergency defending.  
...
{% include quote.html
  mode=""
  quote="[Alexey Miranchuk] is so good. I love playing with him and he is a great guy both on and off the field. He is great technically, and is clean [on the ball], but I would say the best part of his game is being creative. So I’ve been trying to learn some of that from him."
  speaker="Cooper Sanchez, Atlanta United Midfielder"
  source="May 2nd, 2026 Post-game Press Conference"
  image="/images/quotes/Cooper Sanchez.jpg"
%}
...
Miranchuk’s influence on the ball defines how Atlanta organizes its attacks.  He positions himself between lines as the central outlet, and teammates rely on him to move the ball out of pressure and into the next phase.  
...
That control extends across phases of play.  Possessions pass through him before progressing, and the timing of each movement follows the moment he releases the ball.  The team’s structure is not fixed in advance, but built through his decisions in real time.  
...
{% include quote.html
  mode=""
  quote="It’s always what we expect of our best players. And this is what we expect from him, and for me he had already done it very well last game also despite the loss"
  speaker="Tata Martino, Atlanta United Head Coach, On the importance of Alexey Miranchuk to the team and leading as captain today"
  source="April 25th, 2026 Post-game Press Conference"
  image="/images/quotes/Tata Martino.jpg"
%}

Martino’s reference to leadership through play appears in those moments.  The ball reaches Miranchuk early, the next action follows his decision, and the team’s shape adjusts with each phase.  Those sequences organize possession and spacing without requiring instruction away from the ball.

---
## What changes when Miguel Almirón returns?

Almirón advances the ball by carrying it through pressure.  He receives facing forward and drives into space, forcing defenders to step toward him and compress around the ball.  Miranchuk advances play differently.  He positions between lines and moves the ball early, drawing defenders out before the next pass breaks the line.  
...
---
## What system does Miranchuk’s role create?
...
{% include quote.html
  mode=""
  quote="It comes from short passes and movement. That’s what we want to do."
  speaker="Alexey Miranchuk, Atlanta United Midfielder"
  source="April 25th, 2026 Post-game Press Conference"
  image="/images/quotes/Alexey Miranchuk.jpg"
%}
...
Atlanta’s current structure runs through Miranchuk.  The ball returns to him, and the next action develops from that touch as sequences unfold.  
...
Almirón’s return will offer a different path forward.  The armband will signal which one Atlanta chooses.  Right now, the team is already playing through Miranchuk.
