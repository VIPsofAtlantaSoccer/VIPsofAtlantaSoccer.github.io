---
layout: page
title: "Chris McCann at Salford City"
subheadline: "Salford City’s Lead PDP Coach prepares academy players for the physical and tactical realities of League Two."
teaser: "The former Atlanta United midfielder now operates at the final academy step before League Two competition."
categories:
  - ATLUTD
  - Players
  - Retired
...
notes: ""
blocking: 
  - "Waiting on a response from media@salfordcityfc.co.uk"
dates:
  - label: "Created"
    date: "2025-12-29"
  - label: "Created"
    date: "2026-01-12 - contacted to media@salfordcityfc.co.uk"
...
His sessions focus on adult match demands.  Players are trained to manage tempo, absorb physical contact, defend first contact in the box, and recognize when game state requires restraint rather than risk.  Evaluation centers on whether those decisions hold under fatigue and under scoreline pressure.

{% include quote.html
  mode=""
  quote="If you're going to get into the first team, hard work is going to get you there.  It’s about showing quality at the right times."
  speaker="Chris McCann"
  source="Official Salford City Podcast, October 3rd, 2025"
  image="/images/quotes/Chris McCann.jpg"
%}
...
At the Professional Development Phase level, McCann speaks frequently about consistency. He links it to reducing the swings between strong and poor performances across a run of matches. The expectation is that players maintain the same defensive concentration, work rate, and decision making whether the game is flowing or scrappy.

{% include quote.html
  mode=""
  quote="I said to the boys... consistency's key. I don't want to be - and I never have been - the type of person that likes going up and down [in] wins, losses, wins, losses ... ultimately the best teams, they never lose, and if they are losing, they find a way to draw."
  speaker="Chris McCann"
  source="Official Salford City Podcast, October 2025"
  image="/images/quotes/Chris McCann.jpg"
%}
