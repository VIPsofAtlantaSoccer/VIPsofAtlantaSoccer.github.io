// ###########################################################################
// Match Day Filters - Opponent / Location / Author / Year / Search
...
document.addEventListener( 'DOMContentLoaded', ( ) => {
    ...
    const Filter_Year     = document.getElementById( 'MatchDay_Filter_Year' );
    ...
    if ( !Filter_Opponent || !Filter_Location || !Filter_Author || !Filter_Year || !Filter_Search || !MatchDay_List ) {
        return;
    }
    ...
    function Apply_Filters( ) {
        ...
        if ( Count_Total )   { Count_Total.textContent = MatchDay_Rows.length.toString( ); }
    ...
    if ( Count_Total )   { Count_Total.textContent = MatchDay_Rows.length.toString( ); }
    if ( Count_Visible ) { Count_Visible.textContent = MatchDay_Rows.length.toString( ); }
} );